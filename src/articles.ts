...
export const articles: Article[] = [
  ...
  },
  {
    ...
    lead: '朝になると「行きたくない」と泣く、お腹が痛いと訴える。登園・登校しぶりは多くの家庭が通る道で、その背景には分離不安や回避による不安の悪循環がある。無理強いと放任のあいだで、家庭ができる穏やかな関わり方を、研究を手がかりに整理する。',
    updated: '2026-07-06',
    publish: '2026-07-06',
    readMin: 7,
    sections: [
      {
        ...
        body: [
          '朝になると登園・登校をいやがる、頭痛や腹痛を訴える、玄関で泣いてしがみつく。こうした登園・登校しぶりは、特別なことではない。米国児童青年精神医学会（AACAP）の家庭向け資料によれば、学校をいやがる気持ちは5〜7歳と11〜14歳に多く、小学校・中学校という新しい環境への移行期に現れやすいとされる。夏休みや病気あけなど、家庭で親と密に過ごした後に始まりやすいことも知られている。',
          '幼い子のしぶりの中心には、しばしば分離不安がある。生後8か月ごろから就学前にかけて、親と離れることに強い不安を示すのは健康な発達の一部だと、AACAPの資料は説明している。多くの場合は成長とともにやわらぐが、不安が強く長引き、登園・通学や友だちづくりといった日常を妨げるようになったときには、見守りだけでなく支援を考える段階に入る。',
          'しぶりは一様ではない。学校不適応・欠席行動を概観したKearney（2008、Clinical Psychology Review）は、登校をいやがる背景を、特定の恐怖や全般的な不安、苦手な対人場面からの回避、親の注目を得ること、家にいることで得られる楽しみ、という複数の機能に整理した。同じ「行きたくない」でも、何がその行動を支えているかは子どもによって異なる。だからこそ、まず背景を丁寧に見立てることが出発点になる。'
        ]
      },
      {
        heading: '回避が不安を強める悪循環',
        body: [
          '不安なことから逃げると、その瞬間はほっとする。ところが、この安心が落とし穴になる。Hofmann と Hay（2018）は、回避が短期的には不安を下げる一方、長期的には「実は大丈夫だった」と学び直す機会を奪い、不安を維持してしまうと整理している。一度休むとますます行きづらくなる、という保護者がよく感じる感覚には、こうした学習のしくみが関わっている。',
          'この悪循環をほどく考え方が、段階的な暴露（エクスポージャー）である。怖いことをいきなり全部やるのではなく、不安の低いところから少しずつ慣らしていく。たとえば「制服に着替えてみる」「校門まで一緒に行く」「保健室で短時間過ごす」のように、踏める段を小さく刻む。小さな成功を積み重ねるうちに、子どもは「行っても大丈夫だった」という経験を自分の中に蓄えていく。',
          'ここで大切なのは、回避を一律に悪者にしないことだ。Hofmann と Hay（2018）は、回避が役立つ局面もあると述べ、行動の背景にある機能を見て、バランスのとれた対応をとることの重要性を指摘している。完全に休ませてしまうと回避が固定されやすい一方、不安を無視した無理強いも逆効果になりうる。少しずつ近づき、できたところを認める。この往復のなかで、登園・登校との距離を縮めていく。'
        ]
      },
      {
        heading: '完全に止めない支援と、見極めるべきとき',
        body: [
          '登園・登校をめぐる関わりでは、つながりを完全には断たない工夫が助けになる。短時間だけ登校する、遅れて行く、付き添う、別室で過ごすなど、ハードルを下げた形で学校との接点を保つ。文部科学省「不登校児童生徒への支援の在り方について」（2019）も、支援のゴールを「登校という結果」だけに置くのではなく、子どもが自分の進路を考え、社会的に自立していくことに重きを置くよう求めている。登校はあくまで手段のひとつであり、急がせすぎないことも支援に含まれる。',
          'ただし、しぶりの裏に深刻な原因が隠れていることもある。いじめや教室での強いストレス、対人場面への恐怖、発達の特性に伴う困りごとなどがあると、暴露的に慣らすだけでは事態がこじれてしまう。Kearney（2008）が示すように、何がその回避を支えているかによって必要な対応は変わる。「ただ慣れれば解決する」と決めつけず、子どもの訴えに耳を傾け、背景を見極める姿勢が欠かせない。',
          '不安が強く長く続き、生活に支障が出ているとき、あるいは背景にいじめや心身の不調が疑われるときは、家庭だけで抱え込まずに専門機関へつなぐ。スクールカウンセラー、児童精神科、教育相談機関などが相談先になる。早めに手をつなぐことが、子どもと家族の負担をやわらげる。'
        ]
      }
    ],
    steps: [
      '「行きたくない」を否定せず、まず気持ちを言葉にして受けとめる。そのうえで、制服に着替える・校門まで行く・短時間だけ過ごすなど、踏めそうな小さな一歩を子どもと一緒に決める。',
      '完全に休ませきるより、付き添い・遅刻・別室登校など形を変えて学校とのつながりを細く保ち、できた日や場面をその都度ことばで認める。',
      '不安が強く長引く、生活に支障が出ている、いじめや体調不良が疑われるときは、家庭で抱え込まずスクールカウンセラーや児童精神科、教育相談機関に相談する。'
    ],
    references: [
