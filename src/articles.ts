...
export const articles: Article[] = [
  {
    ...
    parentNote: [
      '私が初めてEBE（エビデンスに基づく教育、Evidence Based Education）に出会ったのは、2020年、コロナ下で「まんがでわかる「学力」の経済学」を読んだときでした。そのなかで、「才能ほめより努力ほめ」の論文が紹介されており、「ぎゃー！今まで3歳の我が子に、『○○できてすごい！』ってほめまくっていた！」と焦ったことを覚えています。',
  ...
  },
  {
    ...
    parentNote: [
      '我が家でも、一日でいちばん大変なのが寝かしつけです。「もう寝るよ」と言ってから実際に寝るまでの長いこと……理想の睡眠時間なんて、日によっては全然守れません。',
      'いろいろ試して、結局いちばん続いたのは「就寝を15分だけ早める」という小さな一歩でした。生活を丸ごと変えようとすると必ず挫折するので、まずそこだけ。ルーティンを守れた日の翌朝は、子どもの機嫌も自分の余裕も少し違う——数字より、そういう手ごたえのほうを信じてやっています。',
    ],
    steps: [
