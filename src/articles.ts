...
export const articles: Article[] = [
  {
    ...
    parentNote: [
      '偉そうに書いていますが、私自身、忙しい朝はつい「すごいね」「上手！」を連発してしまいます。理屈を知っていても、とっさに出る言葉はなかなか変わりません。',
      'それでも、「全部を完璧にやらなきゃ」と気負うのをやめて、1日1回、見たことをそのまま言葉にするくらいの気持ちで続けていたら、少しずつ自然になってきました。ほめ方を"技術"として頑張るより、まず親の側が肩の力を抜くほうが先かもしれない、というのが2児の父としての実感です。',
    ],
    steps: [
