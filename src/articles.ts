...
export const articles: Article[] = [
  ...
  },
  {
    ...
    lead: '「散らかった机では集中できない」は本当でしょうか。幼稚園の教室で行われた実験、家庭の“カオス”と子どもの発達をめぐる大規模レビュー、散らかりが伝染することを示した割れ窓理論の実験、そして逆に「散らかった部屋のほうが創造的になる」という研究まで。片づけと子どもの学び・親のストレスの関係を、完璧主義にならない範囲で整理します。',
    posted: '2026-08-21',
    updated: '2026-08-21',
    publish: '2026-08-21',
    draft: true,
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'ただし正直に言えば、これらの大半は相関研究です。散らかりが原因で発達が損なわれるのか、経済的・時間的な余裕のなさが散らかりと発達の両方に影響しているのか、研究からは切り分けられません。「散らかった家の子は伸びない」と因果で語れる段階ではないことは、はっきり書いておきます。',
      ...
      },
      {
        ...
        body: [
          '「割れ窓理論」の名で知られる現象を、フローニンゲン大学のカイザーら（2008）は路上実験で確かめました。壁が落書きだらけの路地では、そうでない路地に比べて、チラシのポイ捨てなどの小さなルール違反をする人が約2倍に増えたのです。乱れた環境は「ここでは守らなくてもよい」という空気を伝染させる——家庭でも、散らかりが散らかりを呼ぶ感覚には、それなりの根拠があるといえます。',
          'ところが逆向きの研究もあります。ヴォースら（2013）の実験では、散らかった部屋で課題に取り組んだ大人のほうが、片づいた部屋の人よりも創造的なアイデアを多く出しました。片づいた環境は健康的な選択や規範に沿った行動を促し、散らかった環境は慣習にとらわれない発想を促す——環境の効果は一方向ではない、という報告です。',
          'これらの実験はいずれも大人対象で、短期の行動を見たものです。子どもの部屋を完璧に整えれば学力が上がる、という話ではありません。遊びかけのブロックや作りかけの工作といった「進行中の散らかり」は、前の記事で紹介したごっこ遊びや創造性の続きでもあります。現実的な落としどころは、勉強する場所の視界と、毎日の小さなリセットの2点に絞り、あとはおおらかに構えることだと思います。',
        ],
      },
    ],
    steps: [
