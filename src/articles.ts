...
export const articles: Article[] = [
  ...
  },
  {
    ...
    parentNote: [
      ...
      'のがよいのではと書いてある本が多かったです。先ほども記載しましたが、今のところは学校以外で、親と離れることはほぼないので、親と連絡するためにはスマホは必要がないので、なんと、上の子は、クラスで一人だけスマホを持っていません。ちょっとかわいそうな気もしますが、コスト的にもちょっと無理です。今後、中学生や',
