...
export const articles: Article[] = [
  ...
  },
  {
    ...
    parentNote: [
      '「自分で決めさせる」——言うのは簡単ですが、実際にやってみると、これがなかなか難しいのです。待っていられずに、つい「早くしなさい」「こっちにしなよ」と先回りしてしまう自分がいます。',
      'コツというほどでもないのですが、我が家では「どっちがいい？」と二択にするくらいがちょうどよかったです。全部を自由に任せると親も子もしんどい。小さな選択でも、本人が選んで、その結果を引き受ける姿を見ると、「あぁ、勝手に育っていくんだな」と少し肩の荷が下りる——そんな気持ちで見守っています。',
    ],
    steps: [
