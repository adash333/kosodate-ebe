...
export const articles: Article[] = [
  ...
  },
  {
    ...
    parentNote: [
      '私がこのテーマを意識したのは2020年、Kindleのおすすめに出てきた『おうち性教育はじめます』という本がきっかけでした。正直、恥ずかしい気持ちがありつつ思い切って購入したのですが、内容は具体的で面白く、「うちの子にはまだ早い」と思っていた考えが変わりました。思春期の子にいきなり性の話をするほうがずっとハードルが高い、という指摘に納得し、ブログに「0歳から性教育始めます！」と宣言までしました。',
